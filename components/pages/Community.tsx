  ...
  function Community() {
    ...
    return (
      <div className="community-container w-full pl-4 py-6 h-screen overflow-hidden">
              ...
              <div className="post-content relative">
                ...
                <div className="post-info  relative">
                  <h2 className={`post-title 
                      ${theme === "dark" ? 'text-white' : 'text-black'}`}>{post.title}</h2>
                  ...
                  <div className="post-header">
                    ...
                    <div className="author-info">
                      <h3 className={`post-title 
                          ${theme === "dark" ? 'text-white' : 'text-black'}`}>{post.author.name}</h3>
        ...
        <div className="sidebar-right w-full ">
          <div className={`account-summary px-2 
            ${theme === 'dark' 
              ? 'bg-gray-950'
              : 'bg-gray-100' 
              }`}>
            ...
            <div className="profile-card">
              ...
              <div className="profile-info">
                ...
                <div className="rating">
                  <span className={`core ${theme === "dark" ? 'text-white' : 'text-black'}`}>
          ...
          <div className={`meetups ${theme === 'dark' 
              ? 'bg-gray-950'
              : 'bg-gray-100' 
            }`}>
            <div className="meetups-header">
              <h3 className={`${theme === "dark" ? 'text-white' : 'text-black'}`}>Meetups</h3>
              <button className={`${theme === "dark" ? 'text-white' : 'text-black'}`}>View all</button>
            </div>
            {meetups.map(meetup => (
              <div key={meetup.id} className="meetup-card">
                ...
                <div className={`date-badge ${theme === "dark" ? ' bg-slate-600' : ' bg-slate-200'}`}>
                  <span className={`month ${theme === "dark" ? 'text-white' : 'text-black'}`}>
                            {meetup.date.month}
                            </span>
                  <span className={`day ${theme === "dark" ? 'text-white' : 'text-black'}`}>
                            {meetup.date.day}
                            </span>
                </div>
                <div className="meetup-info w-full">
                  <h4 className={`${theme === "dark" ? 'text-white' : 'text-black'} text-[14px]`}>{meetup.title}</h4>
                  <div className={` ${theme === "dark" ? ' text-slate-500' : ' text-slate-500/20'} company-info text-xs font-semibold` }>
