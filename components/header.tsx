...
const Header = () => {
  return (
    <div className='flex flex-1 items-center bg-gray-950 px-8  h-[13vh] mb-2'>
      <div className="flex flex-row justify-evenly w-full items-center">

        <div id='logo' className=' flex justify-center mr-16 items-center'>
            <Image src={logo} alt='logo' height={32} className=""/>
        </div>
        <div className="w-[70%] flex flex-row items-center bg-black rounded-full mx-4 mr-10 px-4 py-2">
