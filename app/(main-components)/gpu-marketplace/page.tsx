    ...
    <div className="flex flex-1 w-full h-screen flex-col bg-white dark:bg-black 
      ...
      <div className="flex flex-row p-4 justify-between shrink-0 items-center">
        <div className="flex flex-row items-center gap-2">
          ...
          <Button 
            variant="outline" 
            className="w-[200px] justify-between text-gray-350 dark:text-gray-950
                       font-medium text-lg bg-gray-950 dark:bg-gray-350 group border-0 rounded-full"
          >
            Sort by
            ...
            <DropdownMenuContent className="w-[200px] bg-gray-950 dark:bg-gray-350">
              <DropdownMenuItem 
              ...
              <DropdownMenuItem 
                ...
                className="text-gray-950 dark:text-gray-350 font-medium text-lg hover:bg-gray-900 
                          hover:bg-gray-dark:300"
              >
                Price: High to Low
              </DropdownMenuItem>
              <DropdownMenuItem 
                ...
                className="text-gray-950 dark:text-gray-350 font-medium text-lg 
                           hover:bg-gray-900 hover:bg-gray-dark:300"
              >
                Popularity
              </DropdownMenuItem>
              <DropdownMenuItem 
