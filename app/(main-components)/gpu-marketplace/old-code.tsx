...
//                       <p className="text-sm text-gray-700 dark:text-white font-medium mt-2 
//                          group-hover:text-gray-800 dark:group-hover:text-[#D8D8D8]">
//                         {gpu.location}
//                       </p>
//                     </div>
//                   </div>
//                   <div className="flex justify-center items-center px-6 py-4 mb-4">
//                     <button className="flex justify-center items-center h-fit rounded-full
//                             text-[15px] font-normal py-1 px-4 
